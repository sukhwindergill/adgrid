...
// SavedAudiencesBar (rendered inside StepTargeting) needs ToastProvider and
// touches auth/backend state that's out of scope for this syntax/render
// smoke test — mocked to an empty, inert state so it doesn't add real
// network/auth dependencies here.
...
function renderStep(props) {
  return render(<ToastProvider><StepTargeting {...props} /></ToastProvider>);
}

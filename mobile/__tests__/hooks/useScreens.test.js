...
const mockScreens = [
  { id: '1', name: 'Lobby Screen', venue_category: 'retail', venue_subtype: 'Clothing', city: 'Toronto', health_status: null, last_seen: new Date().toISOString(), screen_photos: [], status: 'active' },
];
